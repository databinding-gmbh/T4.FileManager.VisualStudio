...
namespace T4.FileManager.VisualStudio.AcceptanceCriteria.Features
{
    ...
    public partial class UT013GenerateFileWithoutModificationsFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "UT013 Generate File without modifications", "\tAs a developer\r\n\tI can generate code with the T4.FileManager and supress changes" +
...
#line hidden
                ...
                table25.AddRow(new string[] {
                            ...
                            "TestOverwrite"});
#line 53
 await testRunner.AndAsync("the following files are generated:", ((string)(null)), table25, "And ");
#line hidden
                ...
                table26.AddRow(new string[] {
                            ...
                            "// second run template"});
#line 56
 await testRunner.AndAsync("I change the line", ((string)(null)), table26, "And ");
#line hidden
#line 59
 await testRunner.WhenAsync("I run the script", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
                ...
                table27.AddRow(new string[] {
                            ...
                            "TestOverwrite"});
#line 60
 await testRunner.ThenAsync("the following files are generated:", ((string)(null)), table27, "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
