...
namespace T4.FileManager.VisualStudio.AcceptanceCriteria.Features
{
    ...
    public partial class UT002GenerateFileInSubfolderFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "UT002 Generate File in subfolder", "\tAs a developer\r\n\tI can generate code with the T4.FileManager with each class in " +
...
#line hidden
                ...
                table8.AddRow(new string[] {
                            ...
                            "TestSubfolder"});
#line 42
 await testRunner.ThenAsync("the following files are generated:", ((string)(null)), table8, "Then ");
#line hidden
            }
...
#line 80
 await testRunner.AndAsync("I change the line", ((string)(null)), table9, "And ");
#line hidden
#line 83
...
#line hidden
                ...
                table11.AddRow(new string[] {
                            ...
                            "TestSubfolder"});
#line 88
 await testRunner.AndAsync("the following files no longer exist:", ((string)(null)), table11, "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
