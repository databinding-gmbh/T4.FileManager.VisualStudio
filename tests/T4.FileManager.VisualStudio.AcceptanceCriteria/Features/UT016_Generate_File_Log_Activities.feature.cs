...
namespace T4.FileManager.VisualStudio.AcceptanceCriteria.Features
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("UT013 Generate File log activities", new string[] {
            "db-127"}, Description="\tAs a developer\r\n\tI can log to the main output file\r\n\tso that I can analyze the g" +
        "eneration process", SourceFile="Features\\UT016_Generate_File_Log_Activities.feature", SourceLine=1)]
    public partial class UT013GenerateFileLogActivitiesFeature
    {
...
#line 1 "UT016_Generate_File_Log_Activities.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "UT013 Generate File log activities", "\tAs a developer\r\n\tI can log to the main output file\r\n\tso that I can analyze the g" +
