...
#line hidden
                ...
                table28.AddRow(new string[] {
                            "2 files generated"});
#line 43
 testRunner.Then("the file \"TestWithLogEnabled.txt\" contains following log fragments", ((string)(null)), table28, "Then ");
#line hidden
            }
...
#line 84
 testRunner.Then("the file \"TestWithCustomLog.txt\" contains following log fragments", ((string)(null)), table29, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
