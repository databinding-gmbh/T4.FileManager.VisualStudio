...
namespace T4.FileManager.NetCore.AcceptanceCriteria.Features
{
    ...
    public partial class UT013GenerateFileWithOverwriteFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "UT013 Generate File with overwrite", "\tAs a developer\r\n\tI can change the behaviour of supress changes to overwrite exis" +
...
#line hidden
                ...
                table23.AddRow(new string[] {
                            ...
                            "TestOverwrite"});
#line 38
 await testRunner.AndAsync("the following files are generated:", ((string)(null)), table23, "And ");
#line hidden
...
#line 41
 await testRunner.AndAsync("I change the line", ((string)(null)), table24, "And ");
#line hidden
#line 46
...
#line hidden
                ...
                table25.AddRow(new string[] {
                            ...
                            "TestOverwrite"});
#line 47
 await testRunner.ThenAsync("the following files are generated:", ((string)(null)), table25, "Then ");
#line hidden
                ...
                table26.AddRow(new string[] {
                            ...
                            "TestOverwrite"});
#line 50
 await testRunner.AndAsync("the following files are cleaned up:", ((string)(null)), table26, "And ");
#line hidden
            }
