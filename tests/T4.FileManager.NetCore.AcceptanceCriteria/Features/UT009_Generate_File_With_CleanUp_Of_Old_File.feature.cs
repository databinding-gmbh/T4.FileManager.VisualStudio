...
namespace T4.FileManager.NetCore.AcceptanceCriteria.Features
{
    ...
    public partial class UT009GenerateFileWithCleanupOldFileFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "UT009 Generate File with cleanup old File", "\tAs a developer\r\n\tI can generate code with the T4.FileManager without taking care" +
...
#line 39
 await testRunner.GivenAsync("I change the line", ((string)(null)), table14, "Given ");
#line hidden
#line 42
 await testRunner.WhenAsync("I run the script", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
                ...
                table15.AddRow(new string[] {
                            "TestOldFilesCleanUp.g.cs"});
#line 43
 await testRunner.ThenAsync("the following files are cleaned up:", ((string)(null)), table15, "Then ");
#line hidden
