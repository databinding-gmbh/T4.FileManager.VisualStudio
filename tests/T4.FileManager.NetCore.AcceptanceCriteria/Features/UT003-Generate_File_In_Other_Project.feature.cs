...
namespace T4.FileManager.NetCore.AcceptanceCriteria.Features
{
    ...
    public partial class UT003GenerateFileInOtherProjectFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "UT003 Generate File in other project", "\tAs a developer\r\n\tI can generate code with the T4.FileManager with each class in " +
