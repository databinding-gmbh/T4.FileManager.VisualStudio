...
#line hidden
        ...
        public virtual async System.Threading.Tasks.Task FeatureSetupAsync()
        {
            ...
            Reqnroll.FeatureInfo featureInfo = new Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "UT003 Generate File in other project", "\tAs a developer\r\n\tI can generate code with the T4.FileManager with each class in " +
        ...
        public async System.Threading.Tasks.Task GenerateFilesInOther_NETProject()
        {
            ...
            Reqnroll.ScenarioInfo scenarioInfo = new Reqnroll.ScenarioInfo("Generate files in other .NET project", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
...
#line 39
 await testRunner.AndAsync("I select the target project \"T4.FileManager.NetCore.AcceptanceCriteria.ExampleTes" +
                        "tProject\"", ((string)(null)), ((Reqnroll.Table)(null)), "And ");
#line hidden
#line 40
